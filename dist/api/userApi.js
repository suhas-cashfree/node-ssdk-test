...
class UserApi {
    ...
    createUser(user, options = { headers: {} }) {
    ...
    createUsersWithListInput(user, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(user, "Array<User>")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
    ...
    deleteUser(username, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getUserByName(username, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/user/{username}'
                .replace('{' + 'username' + '}', encodeURIComponent(String(username)));
            let localVarQueryParameters = {};
    ...
    loginUser(username, password, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateUser(username, user, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/user/{username}'
                .replace('{' + 'username' + '}', encodeURIComponent(String(username)));
            let localVarQueryParameters = {};
