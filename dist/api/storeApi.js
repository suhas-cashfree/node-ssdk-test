...
exports.StoreApi = exports.StoreApiApiKeys = void 0;
...
class StoreApi {
    constructor(basePathOrUsername, password, basePath) {
        ...
        this.authentications = {
            ...
            'petstore_auth': new models_2.OAuth(),
            'api_key': new models_2.ApiKeyAuth('header', 'api_key'),
        };
        this.interceptors = [];
        if (password) {
            if (basePath) {
    ...
    deleteOrder(order_id, options = { headers: {} }) {
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "{ [key: string]: number; }");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    getOrderById(order_id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/store/order/{orderId}'
                .replace('{' + 'orderId' + '}', encodeURIComponent(String(order_id)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Order");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    placeOrder(order, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
